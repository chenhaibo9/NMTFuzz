...
def snpyzzz_translate_with_token_prob_ch2en(model, tokenizer, input_text, device, beam_size=5):
    src_lang = "zh_CN"
    tgt_lang = "en_XX"
...
def fuzz_omission_snypzzz_ch2en(args, snypzzz_model, snypzzz_tokenizer, snypzzz_device, word_align_model,
    ...
    result_path = "/home/ubuntu/Desktop/DFuzz4NMT/experiment/mbart_results_ch2en_"
    gen_num_path= "/home/ubuntu/Desktop/DFuzz4NMT/experiment/mbart_gen_num_result_ch2en_"
    ...
    for file_info in file_infos:
        ...
        buglist_data_path = "/home/ubuntu/Desktop/DFuzz4NMT/experiment/mbart_ch2en/" + str(
            file_name) + "/buglist_allMR_ch2en_" + str(file_name)
        gen_data_path = "/home/ubuntu/Desktop/DFuzz4NMT/experiment/mbart/" + str(
            file_name) + "/gen_data_allMR_ch2en_" + str(file_name)
        ...
        while len(lines) > 0:
            ...
            original_translated_text, original_chosen_beam_tokens_info = snpyzzz_translate_with_token_prob_ch2en(
                snypzzz_model, snypzzz_tokenizer, origianl_seed, device=snypzzz_device)
            ...
            while len(sequence) > 0 and trails < max_trails:
                ...
                for i in range(m_num):
                    ...
                    total_count += 1
                    all_8_gen_num += 1
                    mutated_translated_text, mutated_chosen_beam_tokens_info = snpyzzz_translate_with_token_prob_ch2en(
                        snypzzz_model,
                        snypzzz_tokenizer,
                        mutated_text,
                        device=snypzzz_device)
...
if __name__ == '__main__':
    ...
    snypzzz_model_path = "facebook/mbart-large-50-many-to-many-mmt"
    snypzzz_model = MBartForConditionalGeneration.from_pretrained(snypzzz_model_path).to(torch.device("cuda:1"))
    snypzzz_tokenizer = MBart50TokenizerFast.from_pretrained(snypzzz_model_path)
    ...
    fuzz_omission_snypzzz_ch2en(args, snypzzz_model, snypzzz_tokenizer, snypzzz_device, word_align_model,
