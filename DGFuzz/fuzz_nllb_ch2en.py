...
def nllb_translate_with_token_prob_ch2en(model, tokenizer, input_text, device, beam_size=5):
    modle_inputs = tokenizer(input_text, return_tensors="pt").to(torch.device(device))

    outputs = model.generate(**modle_inputs, num_beams=beam_size, output_scores=True, return_dict_in_generate=True,
...
def fuzz_omission_nllb_ch2en(args, nllb_model, nllb_tokenizer, nllb_device, word_align_model,
    ...
    result_path = "/home/ubuntu/Desktop/DFuzz4NMT/experiment/nllb_results_ch2en_"+str(args.seed)
    gen_num_path= "/home/ubuntu/Desktop/DFuzz4NMT/experiment/nllb_gen_num_result_ch2en_"+str(args.seed)
    ...
    for file_info in file_infos:
        ...
        buglist_data_path = "/home/ubuntu/Desktop/DFuzz4NMT/experiment/nllb_ch2en/" + str(
            file_name) + "/buglist_allMR_ch2en_" + str(file_name)
        gen_data_path = "/home/ubuntu/Desktop/DFuzz4NMT/experiment/nllb_ch2en/" + str(
        ...
        while len(lines) > 0:
            ...
            original_translated_text, original_chosen_beam_tokens_info = nllb_translate_with_token_prob_ch2en(
            ...
            while len(sequence) > 0 and trails < max_trails:
                ...
                for i in range(m_num):
                    ...
                    total_count += 1
                    all_8_gen_num += 1
                    mutated_translated_text, mutated_chosen_beam_tokens_info = nllb_translate_with_token_prob_ch2en(
                        nllb_model,
                        nllb_tokenizer,
                        mutated_text,
                        device=nllb_device)
...
if __name__ == '__main__':
    ...
    fuzz_omission_nllb_ch2en(args, nllb_model, nllb_tokenizer, nllb_device, word_align_model,
